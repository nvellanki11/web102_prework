...
function addGamesToPage(games) {
    ...
    for (const game of games) {
        ...
        // append the game to the games-container under Our Games
...
raisedCard.innerHTML = `
    <p>$${raised.toLocaleString('en-US')}</p>
`;

// grab number of games card and set its inner HTML
const gamesCard = document.getElementById("num-games");
let numGames = GAMES_JSON.reduce( (acc, game) => {
    return acc + 1;
}, 0);
gamesCard.innerHTML = `
...
// create a string that explains the number of unfunded games using the ternary operator
    let unfundedString = numUnfunded === 1 ? "1 game remains unfunded" : `${numUnfunded} games remain unfunded`;

// create a new DOM element containing the template string and append it to the description container
    descriptionContainer.innerHTML += `
        <p>A total of $${raised.toLocaleString('en-US')} has been raised for ${numGames} games. Currently, ${unfundedString}. We need your help to fund these amazing games!</p>
    `;
/************************************************************************************
